...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_planck_grid(
      ...
      KC_MUTE,KC_LCTRL,KC_LALT,KC_RGUI,LT(LOWER,KC_BSPACE),KC_SPACE,KC_NO,LT(RAISE,KC_ENTER),KC_LALT,KC_VOLD,KC_VOLU,KC_MPLY
    ),
  ...
  [_LOWER] = LAYOUT_planck_grid(
      ...
      _______,_______,_______,_______,_______,UNICODE_MODE_FORWARD,KC_NO,_______,_______,_______,_______,_______
    ),
  ...
  [_RAISE] = LAYOUT_planck_grid(
      ...
      _______,_______,KC_BTN1,KC_BTN2,KC_MUTE,KC_VOLD,KC_MS_L,KC_MS_D,KC_MS_U,KC_MS_R,KC_HOME,KC_END,
  ...
  [_ADJUST] = LAYOUT_planck_grid(
      ...
      _______,_______,MU_ON,MU_OFF,MU_TOG,_______,RESET,_______,_______,_______,_______,_______,
